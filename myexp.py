...
def initexp(cfg):
    ...
    cfg['block_names'] = ['Reach with cursor', 'Reach without cursor', 'Reach with cursor', 'Reach with cursor',
                          'Reach without cursor', 'Reach with cursor', 'Reach without cursor', 'Reach with cursor',
                          'Reach without cursor', 'Reach without cursor', 'Reach with cursor', 'Reach without cursor',
    ...
    cfg['garage_left_right'] = ['both', 'both', 'both', 'both', 'both', 'both', 'both', 'both', 'left', 'left', 'both',
                                'right', 'right']
    cfg['target_angles'] = [75, 105, 90]

    # DISPLAY_CONFIG
    cfg['target_distance'] = 2
