...
def initexp(cfg):
    ...
    cfg ['block_names'] = ['Reach with cursor', 'Reach without cursor', 'Reach with cursor', 'Reach with cursor',
                           'Reach without cursor', 'Reach with cursor', 'Reach without cursor', 'Reach without cursor',
                           'Reach with cursor', 'Reach without cursor', 'Reach without cursor']
    cfg['trial_numbers'] = [9, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]
    cfg['rotations'] = [0, 0, 0,30, 0,30, 0,0,30, 0,0]
    cfg['garage_distance'] = ['far', 'far', 'far','far', 'far', 'far', 'far', 'far', 'far', 'far', 'far']
    cfg['garage_left_right'] = ['both', 'both', 'both','both', 'both', 'both', 'left','left','both', 'right', 'right']
